    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="space-y-6 p-4">
            <div class="max-w-3xl space-y-2">
                ...
                <p class="text-muted-foreground">Browse the live service catalog and create orders on behalf of customers.</p>
            </div>
                ...
                <Card v-for="category in categories" :key="category.id" class="border-0 shadow-sm ring-1 ring-black/5">
                    ...
                    <CardContent class="space-y-4">
                        ...
                        <Button as-child class="w-full">
                            <Link :href="route('admin.services.category', { category: category.slug })">View Services</Link>
                        </Button>
                    </CardContent>
                </Card>
            </div>
