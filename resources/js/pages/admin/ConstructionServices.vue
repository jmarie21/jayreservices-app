...
const isStyle = (style: string): style is 'Construction Basic Style' | 'Construction Deluxe Style' | 'Construction Premium Style' | 'Construction Luxury Style' |   'Construction Talking Heads' => {
    return ['Construction Basic Style', 'Construction Deluxe Style', 'Construction Premium Style', 'Construction Luxury Style', 'Construction Talking Heads'].includes(style);
};
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <ConstructionBasicForm
            v-if="selectedService?.name === 'Construction Basic Style'"
            :open="true"
        ...
        <ConstructionPremiumForm
            v-if="selectedService?.name === 'Construction Premium Style'"
            :open="true"
            :base-price="selectedService.price"
            :service-id="selectedService.id"
            @close="closeModal"
        ...
        <ConstructionLuxuryForm
            v-if="selectedService?.name === 'Construction Luxury Style'"
            :open="true"
            :base-price="selectedService.price"
            :service-id="selectedService.id"
            @close="closeModal"
