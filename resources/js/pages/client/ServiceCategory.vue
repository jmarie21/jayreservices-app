...
const page = usePage<{ category: ServiceCategory }>();
...
const breadcrumbs = computed<BreadcrumbItem[]>(() => [
    ...
    },
    {
        ...
        href: `/services/${category.value.slug}`,
    },
]);
                ...
                >
                    ...
                    <CardContent class="flex min-h-0 flex-1 flex-col gap-4 p-6">
                        ...
                        <div class="mt-auto shrink-0 border-t pt-4">
                            <Button class="w-full" @click="selectedService = service">Order This Service</Button>
                        </div>
                    </CardContent>
                </Card>
            </div>
